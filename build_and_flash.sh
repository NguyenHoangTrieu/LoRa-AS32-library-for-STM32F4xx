...
ESPFLASH="/home/trieunguyen/.cargo/bin/espflash"
...
sudo "$ESPFLASH" flash /home/esp_rust/hello_world/target/riscv32imc-esp-espidf/release/ --chip esp32c3 --baud 460800 --port /dev/ttyACM0
sudo "$ESPFLASH" flash /home/esp_rust/hello_world/target/riscv32imc-esp-espidf/release/ --chip esp32c3 --baud 460800 --port /dev/ttyACM1
